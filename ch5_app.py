...
radioButton1=dcc.RadioItems(id='radioButton1',options=['red','orange','green'], value='red')
...
@app.callback(
    ...
    Input(component_id='radioButton1',component_property='value')
)
def update_markdown(value_slider,radiotButtonValue):
    title_size = {'fontSize': 12+2*value_slider, 'color':radiotButtonValue}
    return title_size
